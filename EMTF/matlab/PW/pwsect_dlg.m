function [h_pwdialog] = pwsect_dlg(Pwhd);
...
%  for each station check to see if first two channels are Hx Hy
   ...
   if( upper(setstr([ Pwhd.chid(1:2,i1)' Pwhd.chid(1:2,i2)'])) == 'HXHY'  | ...
     ...
     nche = nch - 2;
     chid = setstr(Pwhd.chid(1:2,i1:i1+nch-1)');
   else
     nche = nch;
     chid = zeros(nch+2,2);
...
uicontrol('Style','edit',...
   ...
   'Callback','NEW_ROT = 1;theta_rot=str2num(get(gco,''String''));');

uicontrol('Style','popupmenu',...
	'parent',h_pwdialog, ...
	'String', ...
	'Amp/Phase | Log Amp/Phase | Real/Imag | Var(Amp/Ph) | Var(Re/Im)',...
	'Units','normalized',...
	'Fontsize',fs_chname, ...
	'FontWeight','bold', ...
