...
c         if (bw(i) .eq .0.0) 
 ...
 120     FORMAT( 5(1X,1PE15.8))
     ...
     1        J=1,nch)
      ...
      close (SPEC_UNIT)
      call dec2dms(stcor(2),stcordms(1,1))
      call dec2dms(stcor(1),stcordms(4,1))
      num_ref = 0
      ...
      write(*,199) name(1:3), name(1:ll2),stcordms,
